...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='%(prog)s fits a multiple-input multiple-output function dataset using a configurable Nu-Support Vector Regressor')
    ...
    parser.add_argument('--svrparams',
                        ...
                        dest='svr_params',
                        required=False,
                        help='Parameters of Nu-Support Vector Regressor constructor')
    ...
    model = sklmo.MultiOutputRegressor(sklsvm.NuSVR(**svr_kwargs))
    ...
    print("Generated one-variable function Nu-Support Vector Regressor model '%s'" % args.model_file)
